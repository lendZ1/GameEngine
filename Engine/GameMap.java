...
public class GameMap{
    ...
    private void adjustCamera(){
        ...
        } else if (player.xpos-cameraOffsetX<panelWidth/2){     //keeps the player within the middle third of the camera
            cameraOffsetX-=player.speed;
        } else if (player.xpos+player.width-cameraOffsetX>panelWidth/2){   //keeps the player within the middle third of the camera
            cameraOffsetX+=player.speed;
        }
        ...
        } else if (player.ypos-cameraOffsetY<panelHeight/2){     //keeps the player within the middle third of the camera
            cameraOffsetY-=player.speed;
        } else if (player.ypos+player.height-cameraOffsetY>panelHeight/2){     //keeps the player within the middle third of the camera
            cameraOffsetY+=player.speed;
        }
    }
